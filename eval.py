...
if __name__ == "__main__":
    ...
    modelPath = "results/control/version_13/model.pt"

    if os.path.exists(modelPath):
        model.load_state_dict(torch.load(modelPath, map_location=getTorchDevice()))
    model.eval()
    ...
    while True:
        ...
        if player == 1:
            ...
            print("AI action probs:", str(mcts_probs))
